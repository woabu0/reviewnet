...
def main():
    ...
    # Define models - RoBERTa will be used as ground truth, so we evaluate 3 others
    # If DeBERTa fails, we'll still have BERT and DistilBERT
    sentiment_models = {
        "BERT": "nlptown/bert-base-multilingual-uncased-sentiment",
        "RoBERTa": "cardiffnlp/twitter-roberta-base-sentiment-latest",  # Used as ground truth
        "DistilBERT": "distilbert-base-uncased-finetuned-sst-2-english",
        "TinyBERT": "huawei-noah/TinyBERT_General_4L_312D",  # TinyBERT for sentiment analysis
        "DeBERTa": "microsoft/deberta-base",  # Using deberta-base instead of deberta-v3-base
    }
    ...
    for model_key, model_name in sentiment_models.items():
        # Skip RoBERTa since it's used as ground truth
        if model_key == "RoBERTa":
            print(f"\n" + "="*70)
            print(f"⏭️  SKIPPING {model_key.upper()} (used as ground truth)")
            print("="*70)
            continue
        ...
        try:
            ...
            if tokenizer and model:
                ...
                if np.sum(valid_mask) > 0:
                    ...
                    # For binary models (DistilBERT, TinyBERT, DeBERTa), use lenient evaluation
                    ...
                    if model_key in ["DistilBERT", "TinyBERT", "DeBERTa"]:
